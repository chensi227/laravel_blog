    ...
    <form action="{{url('admin/config/'.$field->id)}})}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>类型：</th>
                <td>
                    <input type="radio" name="type" value="input" @if($field->type=='input') checked @endif onclick="showTr()">input　
                    <input type="radio" name="type" value="textarea" @if($field->type=='textarea') checked @endif onclick="showTr()">textarea　
                    <input type="radio" name="type" value="radio" @if($field->type=='radio') checked @endif onclick="showTr()">radio
                </td>
            </tr>
            <tr class="value">
                <th>类型值：</th>
