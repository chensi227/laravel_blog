	...
	<ul>
		...
		<li>
			...
			<ul class="sub_menu" style="display: block;">
				...
				<li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-fw fa-database"></i>导航栏设置</a></li>
				<li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-database"></i>网站设置</a></li>
			</ul>
		</li>
	</ul>
</div>
